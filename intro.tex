...
We have assembled a large trait data set that includes chromosome number, sex chromosome system, and reproductive mode.
We analyze this data in both a taxonomic and phylogenetic framework to determine the impact of sexual system on rates of chromosome number evolution, the source of transitions in sex chromosome systems, and identify differences in patterns of chromosome number evolution across orders.
