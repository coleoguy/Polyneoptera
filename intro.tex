...
In contrast, increases in chromosome number can occur due to simple chromosome fission in the centromere region. %add a citation here
...
Demiploidy events can occur by the joining of haploid gamete with an unreduced diploid gamete. %cite
Finally, whole genome duplication can lead to a doubling of chromosome number. %cite
...
In \textit{Drosophila} females with three X chromosomes, expression of genes in each X chromosome is reduced such that the total X chromosome gene expression matches with that of females with two X chromosomes.%cute
